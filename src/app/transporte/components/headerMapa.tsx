...
export function PalletHeader({
  ...
  const qrCodeData = `${transporte};${index}${bloco.pallet};${totalCaixas};${totalUnidades};${enderecosUnicos};${categoria};${empresa}`;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs opacity-90">
                ID: {index}
                {bloco.pallet} | Cliente: {transporte} | Desc Cliente:{" "}
